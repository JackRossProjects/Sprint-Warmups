...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  I can't imagine being in a work enviornment without these principals. I really like that we can now build tests to check on our code instead of just looking at it. Passing tests is the first thing I notice followed by propper commenting. It can help so much to understand what you're actually dealing with.
  
- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
  
A container image is a lightweight, standalone, executable package of software that includes everything needed to run an application. Don't want to install everything to base and get things messy? Containers can help. It's like a psuedo-isolated enviornment!
